...
class WorldStatesDataModel {
  WorldStatesDataModel({
      String? name, 
  ...
  WorldStatesDataModel.fromJson(dynamic json) {
    _name = json['name'];
  ...
  String? _cioc;
  bool? _independent;
WorldStatesDataModel copyWith({  String? name,
  List<String>? topLevelDomain,
  String? alpha2Code,
  String? alpha3Code,
  List<String>? callingCodes,
  ...
  String? cioc,
  bool? independent,
}) => WorldStatesDataModel(  name: name ?? _name,
